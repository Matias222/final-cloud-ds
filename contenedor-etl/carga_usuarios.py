...
ATHENA_TABLE = f'servicio-vuelos-{STAGE}-usuario'
...
def main():
    ...
    if query_results:
        ...
        for row in data: temp.append({"user_id":row[0],"password":row[1]})
        
        funciones_bd.insert_multiple_rows_to_mysql("Usuarios",temp)
