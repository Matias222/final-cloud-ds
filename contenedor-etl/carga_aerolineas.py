...
ATHENA_TABLE = 'servicio-vuelos-aero-dev-aerolineas'
...
def main():
    ...
    if query_results:
        ...
        for row in data: temp.append({"tenant_id":row[3],"codigo":row[2],"nombre":row[0],"pais_origen":row[1]})
        
        funciones_bd.insert_multiple_rows_to_mysql("Aerolineas",temp)
